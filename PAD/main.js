...
function init(){
  ...
  for(var i = 0 ; i < pair.length ; ++ i){
    ...
    if(keyAndValue[0] == "layout"){ layout = keyAndValue[1]; }
    else if(keyAndValue[0] == "route"){ route = keyAndValue[1]; }
    else if(keyAndValue[0] == "date"){ date = keyAndValue[1]; }
    else if(keyAndValue[0] == "ctwMode"){ ctwMode = keyAndValue[1]; }
  }
