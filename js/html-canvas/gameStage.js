...
var BASE_LEFT;
var BASE_TOP;
var TR_NUM = parseInt( $("#BaseCanvas").attr("tr") );
var TD_NUM = parseInt( $("#BaseCanvas").attr("td") );
...
function resetBase(){
    TR_NUM = parseInt( $("#BaseCanvas").attr("tr") );
    TD_NUM = parseInt( $("#BaseCanvas").attr("td") );
    BASE_LEFT = $("#BaseCanvas").offset().left;
    BASE_TOP = $("#BaseCanvas").offset().top;
}
...
function resetTimeLifeDiv(){
    $("#timeLifeIcon").offset( { 
        top  : $("#BaseCanvas").offset().top-$("#timeLifeIcon").height(),
        left : $("#BaseCanvas").offset().left
    } );
